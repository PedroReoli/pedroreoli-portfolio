      ...
      <div className="w-full">
        <div className="flex justify-between items-center mb-2">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-small font-medium text-gray-300">Proficiência</span>
          </div>
          <div className="flex items-center">
            <span className="text-small text-gray-400 mr-2">{level.toFixed(1)}/3</span>
            <div className="flex">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6">
          ...
          >
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <p className="text-gray-400 text-small">
                      {skill.area.charAt(0).toUpperCase() + skill.area.slice(1)}
                    </p>
                  </motion.div>
                </div>
                <button
            ...
            <div className="px-6">
              <div className="flex space-x-2 border-b border-gray-800/50">
                <button
                  ...
                  className={`relative px-4 py-2.5 text-small font-medium rounded-t-lg transition-colors ${
                ...
                {activeTab === "about" && skill.description && (
                  ...
                  >
                    <div className="bg-gray-800/30 p-5 rounded-2xl border border-gray-800/50">
                      <p className="text-gray-300 text-small leading-relaxed">{skill.description}</p>
                    </div>

                    {skill.courses.length > 0 && (
                      <button
                        onClick={() => setActiveTab("courses")}
                        className="w-full flex items-center justify-between p-3 rounded-xl bg-gray-800/20 hover:bg-gray-800/30 transition-colors text-small text-gray-300 hover:text-white group"
                      >
                          ...
                          >
                            ...
                            >
                              <div className="flex items-center gap-3 flex-1 min-w-0">
                                ...
                                <span className="text-gray-300 group-hover:text-white transition-colors truncate text-small">
                                  {course}
                                </span>
                              </div>
            ...
            <div className="p-4 flex justify-end border-t border-gray-800/30">
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-full text-small font-medium bg-gray-800 hover:bg-gray-700 text-white transition-colors"
              >
                Fechar
              </button>
            </div>
